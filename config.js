...
// Owner information
global.Owner = process.env.OWNER ? process.env.OWNER.split(",") : ["914715141596"];
global.OwnerNumber = process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.split(",") : ["914715141596"];
global.ownertag = process.env.OWNER_TAG ? process.env.OWNER_TAG.split(",") : ["914715141596"];
